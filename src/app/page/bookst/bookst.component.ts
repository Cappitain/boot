...
@Component({
  ...
  templateUrl: './bookst.component.html',
  styleUrl: './bookst.component.scss'

})
export class BookstComponent {
  users = Array<MemberInfo>();
  constructor(private router: Router, private dataService:DataService, private http:HttpClient
    ,private dialog:MatDialog) {http.get(dataService.apiEndpoint + "/memberInfofliter01").subscribe((data:any) =>{
